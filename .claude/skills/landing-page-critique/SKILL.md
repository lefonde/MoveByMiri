...
description: Section-by-section audit of a landing page against conversion and UX best practices. Provide the page URL or component path.
argument-hint: Page URL or file path
---

# Landing Page Critique

Audit this landing page: $ARGUMENTS
...
1. **Visual hierarchy**: What does the eye hit first? Is it the right thing?
2. **Scannability**: Can you get the gist from headlines alone?
3. **Conversion path**: Clear path from any section to the CTA?
4. **Missing sections**: Any sections from the anatomy that should be added?
